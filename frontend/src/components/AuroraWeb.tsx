...
export interface AuroraWebProps {
  colorStops?: string[];
  amplitude?: number;
  blend?: number;
  speed?: number;
...
export default function AuroraWeb(props: AuroraWebProps) {
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      const width = ctn.offsetWidth || (typeof window !== 'undefined' ? window.innerWidth : 400);
      const height = ctn.offsetHeight || (typeof window !== 'undefined' ? window.innerHeight : 800);
