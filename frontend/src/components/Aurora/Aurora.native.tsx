...
const DEFAULT_STOPS: [string, string, string] = ['#7cff67', '#B497CF', '#5227FF'];

/**
 * Native Northern Lights Aurora curtain matching the React Bits WebGL shader.
 * Renders undulating vertical aurora waves across the screen.
 */
export default function Aurora({
  ...
  return (
    <View style={StyleSheet.absoluteFillObject} pointerEvents="none">
      ...
      {/* Wave Layer 2: Mid & Right Curtain */}
      <Animated.View
        style={[
          styles.curtain,
          {
      ...
      {/* Wave Layer 3: High Ambience Curtain */}
      <Animated.View
        style={[
          styles.curtain,
          {
